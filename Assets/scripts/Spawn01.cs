...
public class Spawn01 : MonoBehaviour
{
    ...
    private void Update()
    {
        ...
        if (gameTime <= 0)
        {
            SceneManager.LoadScene("Spawn02");
        }
    }
    public void SpawnYellow()
    {
        ...
        cubeYellow2.transform.position = spawnPoints[1].transform.position;
        ...
        cubeYellow6.transform.position = spawnPoints[5].transform.position;
        GameObject cubeYellow7 = Instantiate(cubeYellowPrefab) as GameObject;
        cubeYellow7.transform.position = spawnPoints[16].transform.position;
    ...
    public void SpawnBlue()
    {
        ...
        cubeBlue4.transform.position = spawnPoints[11].transform.position;
        GameObject cubeBlue5 = Instantiate(cubeBluePrefab) as GameObject;
        cubeBlue5.transform.position = spawnPoints[18].transform.position;
    }
}